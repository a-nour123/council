    ...
    <div class="container">
        ...
        <div class="main-content" style="margin-bottom:10px ">
            ...
            <h2 style="text-align: center; margin-bottom:15px;margin-top: 30px;" class="mb-4">محضر
                ...
                لمجلس {{ $data['session']->department->ar_name }}
                {{ $data['session']->department->faculty->ar_name }}</h2>
            ...
            <h3 style="text-align: center;" class="text-primary mb-3">أعضاء القسم</h3>
        ...
        <div class="cover-wrapper-footer"
            ...
            <h2 style="text-align: center; margin-bottom:15px;margin-top: 30px;" class="mb-4">محضر
                {{ $data['sessionOrder'] }}
                ل{{ $data['session']->department->ar_name }}
                {{ $data['session']->department->faculty->ar_name }}</h2>
