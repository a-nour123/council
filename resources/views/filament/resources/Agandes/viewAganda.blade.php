    ...
    <div class="progress-wrapper" style="width:100%">
            ...
            <ul class="steps-container  flex justify-between">
                <li class="step step01 active">
                    <div class="step-inner">
                        {{-- <?= $langData['Step 1'] ?> --}}
                        <?= $langData['GeneralInfo'] ?>
                    </div>
                </li>
                <li class="step step02">
                    <div class="step-inner">
                        <?= $langData['RequestData'] ?>
                    </div>
                </li>
                @if (auth()->user()->position_id == 3 && $agenda->status == 0)
            ...
            <div id="progress-content-section">
                <div class="section-content step1 active">
                    ...
                    <label for="academicYear"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><?= $langData['Academic year'] ?></label>
                    <input type="text" id="academicYear" readonly disabled value="{{ $acadimic_year }}"
                    ...
                    <input type="text" id="faculty" readonly disabled value="{{ $faculty }}"
                        @if (!auth()->user()->hasRole('Super Admin') && !auth()->user()->hasRole('System Admin')) style="display: none;" @endif
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">


                    <label for="department"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><?= $langData['Department'] ?></label>
                    <input type="text" id="department" readonly disabled value="{{ $department }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">


                    <label for="mainTopicTitle"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><?= $langData['Main topic'] ?></label>
                    <input type="text" id="mainTopicTitle" readonly disabled value="{{ $mainTopicTitle }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">


                    <label for="subTopicTitle"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><?= $langData['Sub Topic'] ?></label>
                    <input type="text" id="subTopicTitle" readonly disabled value="{{ $subTopicTitle }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <div class="flex space-x-4 mb-2">
                        <div class="flex-1">
                            ...
                            <input type="text" id="status" readonly disabled value="{{ $status }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        <div class="flex-1">
                            ...
                            <input type="text" id="rejectReason" readonly disabled
                                value="{{ $rejectReason ?? 'لا يوجد' }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                    </div>

                    <label for="requestUpdates"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><?= $langData['Request updates'] ?></label>
                    <input type="text" id="subTopicTitle" readonly disabled value="{{ $updates }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">

                    <!-- this class sending topic ids to calling form bulider content -->
                    <div class="" hidden>
                        <label for="mainTopic"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><?= $langData['Main topic'] ?></label>
                        <select id="mainTopic"
                ...
                <div class="section-content step2">
                    ...
                    <div id="form-entry-template" class="form-entry" style="display: none;">
                        ...
                        <div name="fb-editor-edit[]" style="width: 100%"
                            class="bg-white dark:bg-gray-800 fb-editor-edit disabled">
                            ...
                            <div class="file-preview" data-photo-id="{{ $photo->id }}">
                                ...
                                @if (in_array(pathinfo($photo->file_path, PATHINFO_EXTENSION), ['jpg', 'jpeg', 'png', 'gif']))
                                    <a href="{{ asset('storage/' . $photo->file_path) }}"
                                        ...
                                        <img src="{{ asset('storage/' . $photo->file_path) }}" alt="Uploaded Photo"
                ...
                @if (auth()->user()->position_id == 3 && $agenda->status == 0)
                    <div class="section-content step3">
                        ...
                        <label for="mainTopic" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            <?= $langData['Edit Status'] ?>
                        </label>
                        <select name="status" id="finalstatus"
                            @if (auth()->user()->position_id == 3) class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    @else
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 disabled" @endif>
                            <option value="0" {{ $status == 0 ? 'selected' : '' }}><?= $langData['Pending'] ?>
                            </option>
                            <option value="1" {{ $status == 1 ? 'selected' : '' }}><?= $langData['Accepted'] ?>
                            </option>
                            <option value="2" {{ $status == 2 ? 'selected' : '' }}><?= $langData['Rejected'] ?>
                            </option>
                            {{-- <option value="3" {{ $status == 3 ? 'selected' : '' }}>
                            <?= $langData['Rejected with notes'] ?></option> --}}
                        </select>

                        <br>
                        <div id="notesSection" style="{{ $status == 3 ? '' : 'display:none;' }}">
                            <label for="notes"
                            ...
                            <textarea name="notes" id="notes" rows="4"
                                ...
                                placeholder="<?= $langData['Enter rejection notes here'] ?>...">{{ $notes }}</textarea>
                        </div>
                        <div class="section-content step3">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var initialFacultyId = "{{ $faculty }}";

                var initialMainTopicId = "{{ $mainTopic }}";
                var initialSubTopicId = "{{ $subTopic }}";
                var initialDepartmentId = "{{ $department }}";
                        ...
                        success: function(response) {
                            ...
                            if (Array.isArray(AgendaTopicFormbuilderData)) {
                                AgendaTopicFormbuilderData.forEach(function(item, index) {
                                    ...
                                    // Initialize the form builder for the cloned element
                                    $clone.find('.fb-editor-edit').formBuilder().promise.then(
                                        function(fb) {
                                            // Delay to ensure form inputs are fully rendered
                                            setTimeout(function() {
                                                    // Check if hijri-input fields are generated
                ...
                $('#finalForm').on('submit', function(e) {
                    ...
                    formData.append('status', $('#finalstatus').val());
                    ...
                    const updateAgendaUrl =
                    "{{ route('updateStatusAgenda') }}"; // Backend URL to update agenda
