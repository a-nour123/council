<x-filament::page>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Fetch departments and their sessions
            $('#year-select, #faculty-select').change(function() {
                ...
                if (selectedYearId && selectedFacultyId) {
                    $.ajax({
                        url: `{{ route('reports.sessions.department') }}`,
                        type: 'GET',
                        data: {
            ...
            $('#department-select').change(function() {
                ...
                if (selectedDepartmentId) {
                    ...
                    if (selectedDepartment) {
                        ...
                        generalChart(selectedDepartment);
                        detailsChart(selectedDepartment);
                    }
                }
            });

            function generalChart(department) {
                ...
                const chartData = {
                    ...
                    title: {
                        text: 'جلسات قسم (' + department.name + ')', // Title of the chart
                    },
                    xAxis: {
                        categories: [
                            'مجموع الجلسات',
                    ...
                    series: [{
                        name: 'sessions',
                        data: [
                            department.total_sessions,
                            department.total_pending_sessions,
                            department.total_accepted_sessions,
                            department.total_rejected_sessions,
                        ],
            ...
            function detailsChart(department) {
                console.log(department);
                ...
                const chartData = {
                    ...
                    series: [{
                        name: 'Sessions',
                        data: [
                            department.total_pendingDecision_sessions,
                            department.total_approvedDecision_sessions,
                            department.total_rejectedDecision_sessions,
                        ],
                        colorByPoint: true, // Different colors for each bar
                        colors: [
                            '#ffc107', // Yellow for Pending sessions
