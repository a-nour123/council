<x-filament::page>
    ...
    <div>
        ...
        <div id="approval-modal" class="modal-background hidden">
            <div class="modal-content">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form action="{{ route('faculty-session-decision-approval', $recordId) }}" id="decisionApprovalForm"
                        method="post">
                        @csrf
        ...
        <div id="signature-modal" class="modal-background hidden">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="p-4 md:p-5 space-y-4">
                    <form id="signatureForm" action="{{ route('faculty-session-attendance.applySigniture') }}" method="POST">
                        @csrf
                        <input type="hidden" name="session_id" id="sessionId" value="{{ $recordId }}">
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <p>وتم استعراض جدول الأعمال ومناقشة ما ورد فيه واتخذ مجلس الكلية القرارات والتوصيات وفق ما يلي :</p>
    ...
    <script>
        ...
        $("#decisionApprovalForm").on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('faculty-session-decision-approval', $recordId) }}",
                method: 'POST',
                data: formData,
        ...
        $(document).ready(function() {
            ...
            $('#submitSignature').on('click', function(e) {
                ...
                $.ajax({
                    url: '{{ route('faculty-session-attendance.applySigniture') }}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
