...
class FacultyReportDetails extends Page
{
    protected static string $resource = FacultySessionResource::class;
    protected static string $view = 'filament.resources.faculty-session-resource.pages.ReportDetails';
    ...
    public $sessionResposibleId, $yearName, $facultyMessage, $sessionOrder,$createdBySignature;
