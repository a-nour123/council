...
class CoverletterSessionDepartement extends Page
{
    protected static string $resource = SessionDepartemtnResource::class;
    protected static string $view = 'filament.resources.session-departemtn-resource.pages.CoverLetter';
    ...
    protected function initializeSessionDetails(Session $session)
    {
        ...
        [$yearCode, $remaining] = explode('_dept_', $session->code);
    ...
    protected function initializeMembers(Session $session)
    {
        ...
        foreach ($users as $userId) {
            ...
            $actualStatus = SessionAttendanceInvite::where('session_id', $session->id)
