...
use App\Filament\Resources\SessionNumbersResource\Pages;
use App\Filament\Resources\SessionNumbersResource\RelationManagers;
...
class SessionNumbersResource extends Resource
{
    ...
    {
        return auth()->user()->can('sessionNumbers', Session::class);
    }
    ...
    {
        return [
            'index' => Pages\ManageSessionNumbers::route('/'),
